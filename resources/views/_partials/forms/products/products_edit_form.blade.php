<div class="col-md-6">
    ...
    <div class="form-group">
        ...
        {!! Form::select('category_id', str_replace('_', ' ', App\Models\Category::lists('name', 'id')), $product->category->id,  [ 'class'=>'form-control product-categories']) !!}
    ...
    <div class="form-group">
        ...
        {!! Form::select('subcategory_id', str_replace('_', ' ', App\Models\SubCategory::lists('name', 'id')), $product->subcategory->id, [ 'class' => 'form-control product-subcategories']) !!}
    ...
    <div class="form-group">
        ...
        {!! Form::select('brand_id', App\Models\Brand::lists('name', 'id'), $product->brand->id, [ 'class'=>'form-control product-brands']) !!}
